from nvdlib.nvdlib import searchCPE, searchCVE, getCVE
...
def SearchSploits(HostArray, apiKey=None):
    ...
    banner("Possible vulnerabilities for " + target, colours.red)
    ...
    for keyword in keywords:
        ...
        println("\n\n┌─" + bcolours.yellow + "[ " + Title + " ]" + bcolours.endc)

        for CVE in ApiResponseCVE:
            println("│\n├─────┤ " + bcolours.red + str(CVE.id) + bcolours.endc + "\n│")
            ...
            println("│\t\t" + bcolours.cyan + "Description : " + bcolours.endc)
            for line in wrapped_description:
                println("│\t\t\t" + line)
            println("│\t\t" + bcolours.cyan + "Severity : " + bcolours.endc + severity + " - " + score)
            println("│\t\t" + bcolours.cyan + "Exploitability : " + bcolours.endc + exploitability)
            println("│\t\t" + bcolours.cyan + "Details : " + bcolours.endc + details)
